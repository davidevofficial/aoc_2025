...
This is my first year participating in the Advent of code and I had a lot of fun, I am definetely going to do this again next year, also I didn't know that inputs from part 1 and part 2 didn't change because otherwise I would have probably changed all files to be like dayx::solution_part1, dayx::solution_part2 and both solution part 1 and part 2 would have shared the same parser and most code (I think this also might have a small impact on performance and binary size but it is basically negligible)
